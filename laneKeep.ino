...
/////////////////////////////////////////////MOTORS////////////////////////////////////////////////////
// speed from 1-255 of duty cycle. i.e speed = 50 => 50% duty cycle
void setSpeed(float speed, int pin) {
  // analogWriteResolution(8);
  // float percent = float(speed / 100);
  float dutycycle = speed; // 255 is max of 8-bit resolution
...
void updateMotorSpeeds(double desiredSpeedR,double desiredSpeedL, double dt) {
  ...
  double leftMotorOutput = leftMotorPID.tick(currentSpeedLeft, desiredSpeedL, dt);
  double rightMotorOutput = rightMotorPID.tick(currentSpeedRight, desiredSpeedR, dt);
...
void setup() {
  ...
  motors_straight(true,83/2,97/2,25); //difference of 42.5,49 or 
  delay(200);
  motors_straight(true,83,97,25); //difference of 42.5,49 or 32.5,38
  double desiredSpeedL = getspeedRight(); // 83; // Example desired speed
  double desiredSpeedL = getspeedLeft(); //97;
  delay(500);
